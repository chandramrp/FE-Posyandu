...
const menuItems = [
	...
	{ title: "Data Balita", icon: Baby, path: "/data-balita" },
	{
		title: "Pemeriksaan Balita",
		icon: Stethoscope,
		path: "/pemeriksaan-balita",
	},
	{ title: "Data Ibu Hamil", icon: HeartPulse, path: "/data-ibu-hamil" },
	{
		title: "Pemeriksaan Ibu Hamil",
		icon: ClipboardList,
		path: "/pemeriksaan-ibu-hamil",
	},
	{ title: "Laporan", icon: FileBarChart, path: "/laporan" },
	{ title: "Manajemen User", icon: Users, path: "/manajemen-user" },
];
